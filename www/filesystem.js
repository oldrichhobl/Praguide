...
function initFileSystem(){
    ...
    window.requestFileSystem(LocalFileSystem.PERSISTENT, 0,
            function(fs) {
              fileSystem = fs;
               app.log("File System : " + fileSystem.root.name);  // obvykle sdcard0
...
function checkConnection() {
    ...
    app.log("check:" + navigator.connection.type);
    app.log("check1:" + Connection.UNKNOWN);
    app.log("check2:" + Connection.ETHERNET);
